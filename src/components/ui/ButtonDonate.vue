<template>
  <div class="button-donate btn-container">
    <a title="Support me on ko-fi.com" class="kofi-button" style="background-color:#FD4650;"
      href="https://ko-fi.com/B0B6MF0IM" target="_blank">
      <span class="kofitext">
        <img src="https://storage.ko-fi.com/cdn/cup-border.png" alt="Ko-fi donations" class="kofiimg">
        Support App on Ko-fi
      </span>
    </a>
  </div>
</template>
